...
def test_putmetadata():
    ...
    op1 = {"id": "OP1"}
    for _key in [
        ParamsRaman.COLLECTION_OPTICS.value,
        ParamsRaman.GRATINGS.value,
        ParamsRaman.SLIT_SIZE.value,
        ParamsRaman.PIN_HOLE_SIZE.value,
        ParamsRaman.COLLECTION_FIBRE_DIAMETER.value,
        ParamsRaman.OTHER.value
    ]:
