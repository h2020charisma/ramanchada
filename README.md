...
[List of CHADA use cases](documents/Use cases CHADA.xlsx): This is a living document - please add to it! Download, make changes, and upload changed doc via the `+` drop-down.

### Relevant Raman manufacturers, OEM software, and file formats
[List of relevant manufacturers and file formats](documents/Raman data formats.xlsx): This is a living document - please add to it! Download, make changes, and upload changed doc via the `+` drop-down.
